...
D.primal_residual_relative_factor_ = options.getOption(reporter,'DCIEQP_primal_residual_relative_factor');
D.dual_residual_relative_factor_ = options.getOption(reporter,'DCIEQP_dual_residual_relative_factor');
D.normal_threshold_ = options.getOption(reporter,'DCIEQP_normal_threshold');
D.normal_tangential_relative_factor_ = options.getOption(reporter,'DCIEQP_normal_tangential_relative_factor');
D.normal_progress_factor_ = options.getOption(reporter,'DCIEQP_normal_progress_factor');
